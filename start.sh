...
# ======== 请在这里修改你的配置 ========
#CLOUDFLARE_URL="ech-img3.playingapi.tech" # 你的 cloudflared 域名
CLOUDFLARE_TOKEN="eyJhIjoiODllMDYzZWYxOGQ3ZmVjZjhlY2E2NTBiYWFjNzZjYmYiLCJ0IjoiNGUyYjU5NGUtOGIzMC00MmIzLWE4ZGQtMDFkMWJkMDkyNDg5IiwicyI6IlpEQmxNbVF4T0RrdFlURXhPQzAwTTJNNUxXSTBORGN0TUdGbFl6YzVNVEJqWVRVMyJ9"
